def test_pierwsze_logowanie_dla_uzytkownikow_innych_niz_admin(login_page):
    """
...
def test_pierwsze_logowanie_administratora():
    """
    ...
    WARUNKI WSTĘPNE:
        - Ustawiono hasło dla użytkownika 'Admin'
    OPIS KROKU:
        1. Przejdź do aplikacji wpisując adres IP urządzenia brzegowego w pole adresu przeglądarki.
    ...
    OCZEKIWANY REZULTAT:
        ...
        który jest dostępny.
        4. Przekierowano na strone logowania.
